    ...
    const loadMetrics = async () => {
      try {
        ...
        const nextMetrics: DashboardMetrics = {
          ...
          activePolls: Array.isArray(polls) ? polls.filter((poll: any) => poll.enabled).length : 0,
          integrations: Array.isArray(integrations) ? integrations.length : 0,
          activeIntegrations: Array.isArray(integrations) ? integrations.filter((integration: any) => integration.enabled).length : 0,
          bots: Array.isArray(bots) ? bots.length : 0,
          activeBots: Array.isArray(bots) ? bots.filter((bot: any) => bot.enabled).length : 0,
